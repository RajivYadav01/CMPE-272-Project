					...
					<form action="storeUser.php" method="post">
						<div class="row form-group">
							<div class="col-md-6">
								...
								<input type="text" id="fname" class="form-control" placeholder="Your firstname" name="fname" required="required">
							</div>
							<div class="col-md-6">
								<label for="lname">Last Name</label>
								<input type="text" id="lname" class="form-control" placeholder="Your lastname" name="lname" required="required">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="userid" class="form-control" placeholder="userid" name="userid" required="required">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="address" class="form-control" placeholder="Your address" name="address">
							</div>
						</div>
