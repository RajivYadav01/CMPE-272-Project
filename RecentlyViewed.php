...
<body >
	...
	<div id="page" onload="new_div">
		...
		<table>
  		<tr>
    		<th>Recently Viewed</th>
  					<?php 
  						/*$reversed = array_reverse($tabArray);
		...
		<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
			<h3><a href="MostViewed.php">Recently Viewed</a></h3>
		</div>
	...
	<?php 
		...
		for ($x = 0; $x <= 4; $x++)
		{
			...
			if($cnt !== 3)
			{
				...
				\"<i class='icon-eye'></i>\"+
				\"</span><h3><a href='".$reversed[$x].".php'>".$reversed[$x]."</a></h3>\"+
				\"</div>\"+
				\"</div>\";
